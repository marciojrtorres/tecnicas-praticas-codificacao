...
/**
 * Classe utilitária com métodos estáticos usados para lidar com strings.
 *
...
public class StringUtil {
  ...
  /**
   * Centraliza uma string dado um número de colunas e caractere de preenchimento, por exemplo:
   *
   * <code>
...
// https://github.com/marciojrtorres/tecnicas-praticas-codificacao/blob/master/documentar-em-vez-de-comentar/src/utils/StringUtil.java
